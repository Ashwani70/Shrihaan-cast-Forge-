...
export const PRODUCTS = [
  ...
  {
    slug: 'framework-accessories-range', name: 'Framework Accessories Range', category: 'framework-accessories',
    itemCode: AOR, image: img('fa-01'),
    gallery: Array.from({ length: 16 }, (_, i) => img(`fa-${String(i + 1).padStart(2, '0')}`)),
    description:
      'A range of formwork and framework accessories. Individual product names, item codes and specifications for this range are available on request.',
    specs: {}, variants: null,
  },
